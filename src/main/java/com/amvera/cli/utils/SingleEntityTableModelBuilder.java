...
public class SingleEntityTableModelBuilder {
    ...
    public SingleEntityTableModelBuilder(Object bean, ObjectMapper objectMapper) {
        this.bean = bean;
        this.objectMapper = objectMapper;
    }
    public SingleEntityTableModelBuilder withLabels(LinkedHashMap<String, Object> labels) {
        this.labels = labels;
        return this;
    }
    public SingleEntityTableModelBuilder withHeader(String[] header) {
        this.header = header;
        return this;
    }
